...
Backend service for the AI coding starter. Everything here lives under `backend/`; run commands from this directory. Production-ready FastAPI template with vertical slice architecture, optimized for AI-assisted development.
...
├── shared/         # Cross-feature utilities (pagination, timestamps, schemas)
├── tests/          # Unit + integration tests
└── main.py         # FastAPI application entry point
alembic/            # Database migrations
docs/               # Standards for logging, typing, testing, linting
docker-compose.yml  # Local Postgres + app service
...
5. Build your first feature slice under `app/`
