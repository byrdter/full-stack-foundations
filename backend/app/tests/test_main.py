...
def test_root_endpoint(client: TestClient) -> None:
    ...
    assert "docs" in data
    assert data["message"] == "AI Foundation for Agentic AI Workflows"
...
def test_openapi_endpoint_accessible(client: TestClient) -> None:
    ...
    assert "info" in data
    assert data["info"]["title"] == "AI Foundation for Agentic AI Workflows"
    ...
    with patch("app.main.get_logger") as mock_get_logger:
        ...
        with TestClient(app):
            ...
            mock_logger.info.assert_any_call(
                ...
                app_name="AI Foundation for Agentic AI Workflows",
                version="0.1.0",
